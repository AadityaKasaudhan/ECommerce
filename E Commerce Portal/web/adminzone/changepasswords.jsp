...
<div class="row">
            <div class="col-md-12">
                ...
                <center><fieldset style="width:100%;height:360px;background-color:cyan;">
                         <form action="../code/changepasswords.jsp" method="post">
            New Password :<input type="passwd" name="npass" placeholder="Enter new  password"/><br><br>
            Confirm Password :<input type="passwd" name="cpass" placeholder="Confirm  password"/><br><br>
